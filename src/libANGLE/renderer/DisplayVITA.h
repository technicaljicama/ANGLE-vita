...
// DisplayVITA.h: Android implementation of egl::Display

#ifndef LIBANGLE_RENDERER_GL_EGL_VITA_DISPLAYVITA_H_
#define LIBANGLE_RENDERER_GL_EGL_VITA_DISPLAYVITA_H_
...
class DisplayVITA : public DisplayEGL
{
  public:
    DisplayVITA(const egl::DisplayState &state);
    ~DisplayVITA() override;
