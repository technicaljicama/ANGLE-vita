...
{
    printf("ANGLE: initialize\n");
    mImplementation->setMemoryProgramCache(mMemoryProgramCache);
    printf("ANGLE: initCaps\n");
    initCaps();
    printf("ANGLE: initWorkarounds\n");
    initWorkarounds();
    printf("ANGLE: mGLState.initialize\n");
...
{
    // std::unique_ptr<FunctionsGL> functionsGL(nullptr);
    // functionsGL->initialize(nullptr);
...
{
    ANGLE_CONTEXT_TRY(mGLState.setProgram(this, getProgramResolveLink(program)));
...
{
    printf("ANGLE: initRendererString\n");
