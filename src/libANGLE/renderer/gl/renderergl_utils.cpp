                  ...
                  MultiviewImplementationTypeGL *multiviewImplementationType)
{
    ...
    *maxSupportedESVersion = gl::Version(3, 1);
    ...
    if (functions->isAtLeastGL(gl::Version(4, 1)) || functions->hasGLExtension("GL_ARB_ES2_compatibility") ||
        functions->isAtLeastGLES(gl::Version(2, 0)))
    {
        caps->maxVertexUniformVectors = 256; // testing QuerySingleGLInt(functions, GL_MAX_VERTEX_UNIFORM_VECTORS);
    ...
    extensions->textureNPOT = false;//functions->standard == STANDARD_GL_DESKTOP ||
